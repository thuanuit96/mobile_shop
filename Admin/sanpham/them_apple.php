 ...
 <style type="text/css" media="screen">
     .form-conp{
    	...
    	<?php 
                ...
                $id=$_GET['id'];
                 $sqldmsp="select * from danhmuc_sp where ten_dm='Apple'";
	...
	<link rel="stylesheet" type="text/css" href="css/them_all.css">
      <!-- Main Content -->
            ...
            <table width="990px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr height="50">
                	<td class="form"><label>tên của sản phẩm</label><br><input  class='form-conp' type="text" name="ten_sp" /></td>
                </tr>
                <tr height="50">
                	<td class="form"><label>giá của sản phẩm</label><br><input class='form-conp' type="text" name="gia_sp" /></td>
                </tr>
                <tr height="50">
                ...
                <tr height="50">
                    <td class="form"><label>Hiện Trạng</label><br><input class='form-conp' type="text" name="hien_trang" /></td>
                </tr>
                <tr height="50">
