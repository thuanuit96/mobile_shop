 ...
 ?>
            ...
            <table width="990px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
            	<tr id="main-navbar" height="36px">
                	<td colspan="12" style='background: #4471c2;'>quản lý sản phẩm <a href="adminstrator.php?page=them_lg">thêm sản phẩm mới (+)</a></td>
                </tr>
                <tr height="30px" id="navbar-title">
                 ...
                 <?php
                    ...
                    $sql_sp="select * from sanpham where thuocdanhmuc='lg' and chuyen_muc='Dien_Thoai' ";
            ...
            ?>                                       
                <tr class="product-item">
                    ...
                    <td class="link"><a href="adminstrator.php?page=sua_lg&id_sp=<?php echo $row_sp['id_sp'] ?>">sửa</a></td>
                    <td class="link"><a class="red" href="adminstrator.php?page=xoa_lg&id_sp=<?php echo $row_sp['id_sp'] ?>">xóa</a></td>
                </tr> 
                ...
                <?php
                        ...
                        echo '<script>alert("Không Có Sản Phẩm LG Nào..");</script>';
                    }
