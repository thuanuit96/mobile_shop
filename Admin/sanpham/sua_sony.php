	...
	<link rel="stylesheet" type="text/css" href="css/sua_all.css">
      <!-- Main Content -->
            ...
            <table width="990px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr height="50">
                	<td class="form"><label>tên của sản phẩm</label><br><input type="text" name="ten_sp" class='form-conp' value='<?php echo $dulieu_row[1];  ?>' /></td>
                </tr>
                <tr height="50">
                	<td class="form"><label>giá của sản phẩm</label><br><input type="text" name="gia_sp" class='form-conp' value='<?php echo $dulieu_row[2];  ?>' /></td>
                </tr>
                <tr height="50">
                 ...
                 <tr height="50">
                    <td class="form"><label>Hiện Trạng</label><br><input type="text" class='form-conp' name="hien_trang" value='<?php echo $dulieu_row[5];  ?>' /></td>
                </tr>
                <tr height="50">
