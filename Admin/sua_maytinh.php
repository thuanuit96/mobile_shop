     ...
     .form-conp{
        ...
        <?php
                ...
                if(isset($_POST['submit_suasp'])){
                    ...
                    $sql_sua="update sanpham set ten_sp='$ten_sp',gia_sp='$gia_sp',hien_trang='$hien_trang',anh_sp='$file_name',mota='$mo_ta',thongso_kithuat='$thongso' where id_sp='$id_sp'";
            ...
            <table width="990px" id="main-content" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr height="50">
                 ...
                 <tr height="50">
                  ...
                  <tr height="50">
                    <td class="form" ><br><label style='color:blue;font-size: 17px;'>Mô Tả,Minh Họa Cho Sản Phẩm</label><br><br><textarea id="elm1" name="mo_ta"><?php echo $anh['mota'] ?></textarea><br/></td>
                </tr>
                 <tr height="50">
