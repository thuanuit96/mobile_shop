     ...
     .form-conp{
    	...
    	<?php 
				...
				if(isset($_POST['submit_themsp'])){
					...
					$sql="insert into sanpham (ten_sp,gia_sp,thuocdanhmuc,hien_trang,chuyen_muc,anh_sp,mota,thongso_kithuat) VALUES ('$tensp','$giasp','$dmsp','$hien_trang','Dien_Thoai','$new_path','$mota','$thongso')";
                ...
                <tr height="50">
                	<td class="form"><label>sản phẩm thuộc danh mục</label><br>
                    	<select name="id_dm">
                        	...
                        	?>                         
                        	<option value=<?php echo $row["ten_dm"];?>><?php echo $row["ten_dm"];?></option>
                          <?php
                          	}
